package com.example.shoppingcart.Payment.api;

import com.example.shoppingcart.Payment.Dto.CreateCardDetailsTokenRequest;
import com.example.shoppingcart.Payment.Dto.ProcessedPaymentDetailsDto;
import com.example.shoppingcart.Payment.Dto.ProcessedPaymentWithClientSecretDto;
...
public interface PaymentApi {
   ...
   */
  ProcessedPaymentWithClientSecretDto processPayment(
      final String cardDetailsTokenId);
   ...
   */
  void processPaymentEvent(final String paymentIntentPayload,
      final String stripeSignatureHeader);

  /**
   * This method is a temporary solution until the front-end goes functional to pass us a token with payment card details. In the meantime, this method serves to test the payment api.
   *
   ...
   */
  String processCardDetailsToken(
      final CreateCardDetailsTokenRequest createCardDetailsTokenRequest);
}
