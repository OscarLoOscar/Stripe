package com.example.shoppingcart.Payment.enums;
...
public enum PaymentStatus {
  ...
  PAYMENT_IS_PROCESSING("payment_intent.processing", "Payment in processing"),

  PAYMENT_IS_CANCELED("payment_intent.canceled", "Payment is canceled"),

  PAYMENT_IS_SUCCEEDED("payment_intent.succeeded", "Payment is succeeded");
